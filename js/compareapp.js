...
function item1(a)
{
  var select2 = document.getElementById("select2").value;
    if(a != select2)
    {
     ...
     document.getElementById('material1').innerHTML = products[a].material
     document.getElementById('size1').innerHTML = products[a].size
     document.getElementById('weight1').innerHTML = products[a].weight
        ...
        document.getElementById('size1').innerHTML = "N/A"
        document.getElementById('weight1').innerHTML = "N/A"
    }
}
function item2(b)
{
  var select1 = document.getElementById("select1").value;
    if(b != select1)
    {
     ...
     document.getElementById('material2').innerHTML = products[b].material
     document.getElementById('size2').innerHTML = products[b].size
     document.getElementById('weight2').innerHTML = products[b].weight
    }
    else{
        ...
        document.getElementById('material2').innerHTML = "N/A"
        document.getElementById('size1').innerHTML = "N/A"
        document.getElementById('weight1').innerHTML = "N/A"
    }
}